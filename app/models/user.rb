...
# took out the :confirmable for devise
  ...
  def give_goals_to_user
      ...
      self.goals.create(category: "Turn off computer instead of hibernate", point_value: 3, frequency: 0, weekly_points_goal: 0, weekly_results: 0)
      ...
      self.goals.create(category: "Plant 1 tree", point_value: 50, frequency: 0, weekly_points_goal: 0, weekly_results: 0)
      self.goals.create(category: "Recycle 5 lb of paper, plastic, or metal", point_value: 15, frequency: 0, weekly_points_goal: 0, weekly_results: 0)
      self.goals.create(category: "Ride bike instead of car 1 mile", point_value: 22, frequency: 0, weekly_points_goal: 0, weekly_results: 0)
      self.goals.create(category: "Add 1 lb to compost pile", point_value: 2, frequency: 0, weekly_points_goal: 0, weekly_results: 0)
      self.goals.create(category: "Take a short shower (5 min or less)", point_value: 4, frequency: 0, weekly_points_goal: 0, weekly_results: 0)
